...
### Задача 2.1: Упростить Tenant Caching 🔥 HIGH ROI
...
**Критерии завершения:**
- [ ] Создан SimplifiedTenantCache с moka
- [ ] Написаны unit tests (stampede, TTL, eviction)
- [ ] Интегрирован в tenant middleware
