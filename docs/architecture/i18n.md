...
2. locale cookie (currently `rustok-admin-locale` for Next Admin)
...
- Full platform alignment is still in progress for storefront URL locale routing and module-level content fallback helpers.
