...
- [Server docs](../apps/server/docs/README.md) (includes mandatory core modules baseline for agents, Loco feature matrix, auth password-reset email delivery, dev seed behavior notes, and build-request event publication wiring)
