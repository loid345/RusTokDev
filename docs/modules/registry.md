...
| `region` | admin + storefront | `in_progress` | `in_progress` | `crates/rustok-region/docs/implementation-plan.md` (slice #13: storefront rail SSR smoke verifies core-owned route/query DOM evidence) |
