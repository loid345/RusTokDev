...
| `product` | admin + storefront | `in_progress` | `in_progress` | `core_transport_ui` | `crates/rustok-product/docs/implementation-plan.md` (slice: storefront native/GraphQL + Leptos adapter split; product admin core helpers, `SelectedProductSummaryViewModel`, `ProductAdminListItemViewModel`, `ProductAdminEditorViewModel`, transport facade and `admin/src/ui/leptos.rs` adapter) |
