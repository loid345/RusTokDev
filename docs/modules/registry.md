...
| `region` | admin + storefront | `in_progress` | `in_progress` | `crates/rustok-region/docs/implementation-plan.md` (slice #2: storefront route/tax/country summaries and selected-region metric view-model moved into framework-agnostic core) |
