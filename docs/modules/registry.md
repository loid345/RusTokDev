...
| `search` | admin + storefront | `in_progress` | `in_progress` | `core_transport_ui` | `crates/rustok-search/docs/implementation-plan.md` (slice #35: storefront result actions render core-owned action view-models; GraphQL fallback unchanged) |
