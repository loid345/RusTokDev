...
| `search` | admin + storefront | `in_progress` | `in_progress` | `core_transport_ui` | `crates/rustok-search/docs/implementation-plan.md` (slice #34: storefront facet cards render core-owned facet view-models; GraphQL fallback unchanged) |
