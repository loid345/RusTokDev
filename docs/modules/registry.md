...
| `product` | admin + storefront | `in_progress` | `in_progress` | `core_transport_ui` | `crates/rustok-product/docs/implementation-plan.md` (slice: storefront pricing-context policy in core, explicit native/GraphQL transport adapters, and Leptos render adapter under `ui/leptos.rs`) |
