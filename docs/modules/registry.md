...
| `payment` | storefront | `in_progress` | `not_started` | `core_only` | `crates/rustok-payment/docs/implementation-plan.md` (`rustok-payment/storefront` owns payment collection card presentation and Leptos-free fallback view-model; transport still reaches payment through commerce checkout orchestration until owner transport cutover) |
