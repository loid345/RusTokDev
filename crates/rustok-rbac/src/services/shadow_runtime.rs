...
mod tests {
    ...
    use crate::{
        CasbinShadowEvaluation, CasbinShadowMismatchRecord, CasbinShadowSkipReason, RbacAuthzMode,
        ShadowCheck,
    };
    ...
    #[test]
    fn runtime_exposes_casbin_shadow_evaluation() {
    ...
    #[test]
    fn runtime_telemetry_tracks_casbin_shadow_only() {
        let tenant_id = uuid::Uuid::new_v4();
        let required = permission(Resource::Users, Action::Delete);
    ...
    fn runtime_exposes_mode_helpers_for_server_adapters() {
        ...
        assert!(!shadow_runtime_runs_casbin(RbacAuthzMode::RelationOnly));
    }
