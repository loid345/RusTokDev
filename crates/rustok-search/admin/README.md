...
- Keeps preview, analytics summary, and analytics table row presentation mapping in framework-agnostic core view-model helpers so the Leptos layer only renders prepared fields and host click actions.
