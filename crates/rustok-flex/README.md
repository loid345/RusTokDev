...
`rustok-flex` contains shared Flex attached-mode contracts extracted from `apps/server`.
...
- `rustok_flex::FieldDefRegistry`
- `rustok_flex::FieldDefinitionService`
- `rustok_flex::{CreateFieldDefinitionCommand, UpdateFieldDefinitionCommand, FieldDefinitionView}`
