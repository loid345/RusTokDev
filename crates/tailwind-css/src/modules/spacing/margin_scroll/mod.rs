...
impl TailwindInstance for TailwindScrollMargin {
    fn attributes(&self, _: &TailwindBuilder) -> CssAttributes {
        ...
        self.axis
            .write_attributes(&mut out, self.size.get_properties());
        out
    }
}
...
impl TailwindScrollMargin {
    ...
    pub fn parse(
        ...
        let (axis, rest) = match pattern {
            ...
            ["mr", rest @ ..] => (
                SpacingAxis::new("scroll-mr", &["scroll-margin-right"]),
                rest,
            ),
            ["mt", rest @ ..] => (SpacingAxis::new("scroll-mt", &["scroll-margin-top"]), rest),
            ["mb", rest @ ..] => (
                SpacingAxis::new("scroll-mb", &["scroll-margin-bottom"]),
                rest,
            ),
            ["mx", rest @ ..] => (
                SpacingAxis::new("scroll-mx", &["scroll-margin-left", "scroll-margin-right"]),
                rest,
            ),
