...
static TRANSLATIONS: Lazy<HashMap<(Locale, &'static str), &'static str>> = Lazy::new(|| {
    ...
    map.insert(
        (Locale::En, "invalid_locale_length"),
        "Locale must be 2-10 characters",
    );
    map.insert(
        (Locale::En, "invalid_locale_format"),
        "Invalid locale format",
    );
    map.insert(
        (Locale::En, "position_must_be_non_negative"),
        "Position must be non-negative",
    );
    map.insert((Locale::En, "position_too_large"), "Position is too large");
    map.insert(
        (Locale::En, "depth_must_be_non_negative"),
        "Depth must be non-negative",
    );
    map.insert(
        (Locale::En, "depth_too_large"),
        "Depth is too large (max 100)",
    );
    map.insert(
        (Locale::En, "reply_count_must_be_non_negative"),
        "Reply count must be non-negative",
    );
    map.insert((Locale::En, "slug_empty"), "Slug cannot be empty");
    map.insert(
        (Locale::En, "slug_too_long"),
        "Slug is too long (max 255 characters)",
    );
    map.insert(
        (Locale::En, "slug_invalid_characters"),
        "Slug can only contain lowercase letters, numbers, and hyphens",
    );
    map.insert(
        (Locale::En, "slug_hyphen_boundary"),
    ...
    map.insert(
        (Locale::Ru, "invalid_locale_length"),
        "Локаль должна быть 2-10 символов",
    );
    map.insert(
        (Locale::Ru, "invalid_locale_format"),
        "Неверный формат локали",
    );
    map.insert(
        (Locale::Ru, "position_must_be_non_negative"),
        "Позиция должна быть неотрицательной",
    );
    map.insert(
        (Locale::Ru, "position_too_large"),
        "Позиция слишком большая",
    );
    map.insert(
        (Locale::Ru, "depth_must_be_non_negative"),
        "Глубина должна быть неотрицательной",
    );
    map.insert(
        (Locale::Ru, "depth_too_large"),
        "Глубина слишком большая (макс. 100)",
    );
    map.insert(
        (Locale::Ru, "reply_count_must_be_non_negative"),
        "Количество ответов должно быть неотрицательным",
    );
    map.insert((Locale::Ru, "slug_empty"), "Slug не может быть пустым");
    map.insert(
        (Locale::Ru, "slug_too_long"),
        "Slug слишком длинный (макс. 255 символов)",
    );
    map.insert(
        (Locale::Ru, "slug_invalid_characters"),
        "Slug может содержать только строчные буквы, цифры и дефисы",
    );
    map.insert(
        (Locale::Ru, "slug_hyphen_boundary"),
    ...
    map.insert(
        (Locale::Es, "invalid_locale_length"),
        "La configuración regional debe tener 2-10 caracteres",
    );
    map.insert(
        (Locale::Es, "invalid_locale_format"),
        "Formato de configuración regional inválido",
    );
    map.insert(
        (Locale::Es, "position_must_be_non_negative"),
        "La posición debe ser no negativa",
    );
    map.insert(
        (Locale::Es, "position_too_large"),
        "La posición es demasiado grande",
    );
    map.insert(
        (Locale::Es, "depth_must_be_non_negative"),
        "La profundidad debe ser no negativa",
    );
    map.insert(
        (Locale::Es, "depth_too_large"),
        "La profundidad es demasiado grande (máx. 100)",
    );
    map.insert(
        (Locale::Es, "reply_count_must_be_non_negative"),
        "El recuento de respuestas debe ser no negativo",
    );
    map.insert((Locale::Es, "slug_empty"), "El slug no puede estar vacío");
    map.insert(
        (Locale::Es, "slug_too_long"),
        "El slug es demasiado largo (máx. 255 caracteres)",
    );
    map.insert(
        (Locale::Es, "slug_invalid_characters"),
        "El slug solo puede contener letras minúsculas, números y guiones",
    );
    map.insert(
        (Locale::Es, "slug_hyphen_boundary"),
        "El slug no puede comenzar o terminar con un guion",
    );
    ...
    map.insert(
        (Locale::De, "invalid_locale_length"),
        "Locale muss 2-10 Zeichen lang sein",
    );
    map.insert(
        (Locale::De, "invalid_locale_format"),
        "Ungültiges Locale-Format",
    );
    map.insert(
        (Locale::De, "position_must_be_non_negative"),
        "Position muss nicht-negativ sein",
    );
    map.insert((Locale::De, "position_too_large"), "Position ist zu groß");
    map.insert(
        (Locale::De, "depth_must_be_non_negative"),
        "Tiefe muss nicht-negativ sein",
    );
    map.insert(
        (Locale::De, "depth_too_large"),
        "Tiefe ist zu groß (max. 100)",
    );
    map.insert(
        (Locale::De, "reply_count_must_be_non_negative"),
        "Antwortanzahl muss nicht-negativ sein",
    );
    map.insert((Locale::De, "slug_empty"), "Slug darf nicht leer sein");
    map.insert(
        (Locale::De, "slug_too_long"),
        "Slug ist zu lang (max. 255 Zeichen)",
    );
    map.insert(
        (Locale::De, "slug_invalid_characters"),
        "Slug darf nur Kleinbuchstaben, Zahlen und Bindestriche enthalten",
    );
    map.insert(
        (Locale::De, "slug_hyphen_boundary"),
    ...
    map.insert(
        (Locale::Fr, "invalid_locale_length"),
        "La locale doit avoir 2 à 10 caractères",
    );
    map.insert(
        (Locale::Fr, "invalid_locale_format"),
        "Format de locale invalide",
    );
    map.insert(
        (Locale::Fr, "position_must_be_non_negative"),
        "La position doit être non négative",
    );
    map.insert(
        (Locale::Fr, "position_too_large"),
        "La position est trop grande",
    );
    map.insert(
        (Locale::Fr, "depth_must_be_non_negative"),
        "La profondeur doit être non négative",
    );
    map.insert(
        (Locale::Fr, "depth_too_large"),
        "La profondeur est trop grande (max. 100)",
    );
    map.insert(
        (Locale::Fr, "reply_count_must_be_non_negative"),
        "Le nombre de réponses doit être non négatif",
    );
    map.insert((Locale::Fr, "slug_empty"), "Le slug ne peut pas être vide");
    map.insert(
        (Locale::Fr, "slug_too_long"),
        "Le slug est trop long (max. 255 caractères)",
    );
    map.insert(
        (Locale::Fr, "slug_invalid_characters"),
        "Le slug ne peut contenir que des lettres minuscules, des chiffres et des traits d'union",
    );
    map.insert(
        (Locale::Fr, "slug_hyphen_boundary"),
