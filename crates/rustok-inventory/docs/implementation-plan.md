...
- Evidence:
  ...
  - public-channel inventory visibility helpers теперь экспортируются из `rustok-inventory`, а `rustok-commerce::storefront_channel` оставляет за собой только request-context wiring и применение inventory-owned availability к commerce DTO.
- Last verified at (UTC): 2026-06-07T07:05:00Z
