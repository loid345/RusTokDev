...
pub trait IntoSyntaxError {
    fn into_syntax_error(self) -> ErrorWithFileSpan<String>;
}

impl IntoSyntaxError for ErrorWithFileSpan<String> {
    fn into_syntax_error(self) -> ErrorWithFileSpan<String> { self }
}

impl IntoSyntaxError for String {
    fn into_syntax_error(self) -> ErrorWithFileSpan<String> { ErrorWithFileSpan::new(self) }
}

impl IntoSyntaxError for &str {
    fn into_syntax_error(self) -> ErrorWithFileSpan<String> { ErrorWithFileSpan::new(self) }
}

impl TailwindError {
    /// Constructor of [`NoteErrorKind::SyntaxError`]
    pub fn syntax_error(error: impl IntoSyntaxError) -> TailwindError {
        let kind = TailwindErrorKind::SyntaxError(error.into_syntax_error());
